...
export const reqAddOrUpdateAttr = (data: attr) => axios.post<any, any>(API.ADD_OR_UPDATE_ATTR_URL, data);
export const reqDeleteAttr = (attrId: number | string) => axios.delete<any, any>(API.DELETE_ATTR_URL + attrId);