        ...
        <el-card>
            <el-form inline>
                <el-form-item label="一级分类">
                    <el-select v-model="categoryStore.c1Id" @change="handler1" :disabled="scene === true ? true : false"
                        placeholder="请选择一级分类">
                ...
                <el-form-item label="二级分类">
                    <el-select v-model="categoryStore.c2Id" @change="handler2" :disabled="scene === true ? true : false"
                        placeholder="请选择二级分类">
